app.component('typing-test-component', {
    template: `
        <div class="typing-test-section">
            ...
            <input type="text" id="hhh" :maxLength="maxLengthInpt" v-model="input_value"
                @input="processInput($event)"
                @keyup.space="processInputSpaceBack($event)"
                @keyup.delete="processInputSpaceBack($event)"
                @keyup="onChangeInput"
                @keydown="playKeyPressSound"
                @keyup="playKeyReleaseSound"
                class="input-field"
                @paste.prevent
                @keyup.ctrl.prevent
            >
